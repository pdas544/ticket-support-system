...
$query = "SELECT t.*, u.name AS user_name, a.name AS agent_name FROM guest_tickets t LEFT JOIN users u ON t.user_id = u.id LEFT JOIN agents a ON t.agent_id = a.id";
if ($fromDate && $toDate) {
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="mt-3">
            ...
            <table id="guestsTicketsTable" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th>Sl. No</th>
                        <th>Subject</th>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><a href='update-guest-record.php?id={$row['id']}' class='btn btn-sm btn-primary update-icon' style='display:none;'><i class='fas fa-edit'></i></a></td>";
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#viewAllRecords').click(function () {
                window.location.href = 'view-guest-tickets.php';
            });
