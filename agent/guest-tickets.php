...
$stmt = $db->prepare("SELECT * FROM guest_tickets WHERE agent_id = ?");
...
<head>
    ...
    <title>Guest User Tickets</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form id="updateForm" method="POST" action="updateGuestTickets.php">
            <table id="ticketsTable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>";
                        echo "<select class='form-select status-select' name='updated-status[{$row['id']}]' data-ticket-id='{$row['id']}' data-table='guest_tickets'>";
